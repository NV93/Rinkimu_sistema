        ...
        <div className="panel-heading">
          ...
          <div className="panel-body">
            ...
            <table className="table table-striped">
              ...
              <tbody>
                <DistrictRepresentativeListViewRowComponent name="Jonas" nr="1"/>
                <DistrictRepresentativeListViewRowComponent name="Petras" nr="2"/>
                <DistrictRepresentativeListViewRowComponent name="As" nr="3"/>
              </tbody>
            </table>
        </div>
    );
